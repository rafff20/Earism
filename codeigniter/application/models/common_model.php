...
class Common_Model extends CI_Model {
	...
	function brand()
	{
		...
		$array['Apple'] = 'Apple';
		$array['Audeze'] = 'Audeze';
		$array['Audio_Technica'] = 'Audio_Technica';
		$array['Beats'] = 'Beats';
		$array['Beyerdynamic'] = 'Beyerdynamic';
		$array['Bose'] = 'Bose';
		$array['Cooler_Master'] = 'Cooler_Master';
		$array['Corsair'] = 'Corsair';
		$array['Google'] = 'Google';
		$array['HiFiMan'] = 'HiFiMan';
		$array['HyperX'] = 'HyperX';
		$array['Jabra'] = 'Jabra';
		$array['JBL'] = 'JBL';
		$array['Logitech'] = 'Logitech';
		$array['MOONDROP'] = 'MOONDROP';
		$array['Philips'] = 'Philips';
		$array['Razer'] = 'Razer';
		$array['Sennheiser'] = 'Sennheiser';
		$array['Shure'] = 'Shure';
		$array['Sony'] = 'Sony';
		$array['SteelSeries'] = 'SteelSeries';
	...
	{
		$array['In-ear'] = 'In-ear';
		$array['Over-ear'] = 'Over-ear';
		$array['On-ear'] = 'On-ear';
		$array['Earbuds'] = 'Earbuds';
