...
<!-- END THEME STYLES -->
<link rel="shortcut icon" href="cdn/icons/E-Bike1.png"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
	...
	<div class="page-header-top">
		<div class="container">
			...
			<div class="page-logo" style="width: 400px">
				<a href="">
					<img src="cdn/icons/Earism.png" alt="Earism" style="width: 160px; height: auto;">
				</a>
			</div>
		...
		<div class="container">
			...
			<div class="hor-menu ">
				...
				<ul class="nav navbar-nav">
					<li>
						<a href="javascript:u1()"><i class="fa fa-comments"></i> Kebutuhan Fungsional</a>
					</li>
                    <!-- <li>
